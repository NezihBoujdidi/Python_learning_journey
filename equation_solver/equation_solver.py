...
** learned the use of __init_subclass__(cls) which takes cls as argument and runs automatically when a class inherits from your base class, it is defined in the abstract class 
to check if the class implementing this abstract class has the attributes defined in the abstract class, if not it raises an error of AttributeError to indicate missing attribute **
